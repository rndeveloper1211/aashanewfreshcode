      ...
      <View style={styles.card}>
        <View style={styles.tileHeader}>
          <View style={styles.tileTitle}>
            <Text style={styles.text}>{translate('AirlineName')}: ${item.AirlineName}</Text>
            <Text style={styles.textBold}>{translate('PNR')}: ${item.PNR}</Text>
            <Text style={styles.text}>{translate('OfferFare')}: ${item.OfferedFare}</Text>
            <Text style={styles.text}>{translate('TicketStatus')}: ${item.TicketStatus == ''?'Ticket Status Not available':item.TicketStatus}`}</Text>
            <Text style={styles.text}>{translate('TicketDate')}: ${item.TicketDate}</Text>
            <Text style={styles.text}>{translate('TraceId')}: ${item.TraceId}</Text>
            <Text style={styles.text}>{translate('Email')}: ${item.Email}</Text>

            <Text style={styles.text}>{translate('transaction_id')}: ${item.reqid}</Text>
            <Text style={styles.text}>{translate('FareAmount')}: ${item.FareAmount}</Text>
            <Text style={styles.text}>{translate('PassengerName')}: ${item.PassengerName === ''?'No Name':item.PassengerNam}</Text>

            <Text style={styles.text}>{translate('Pre Balance')}: ${item.RemPre}</Text>
            <Text style={styles.text}>{translate('Pre Balance')}: ${item.RemPost}</Text>
