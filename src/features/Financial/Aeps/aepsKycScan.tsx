    ...
    <SafeAreaView style={[styles.main, { backgroundColor: isDarkMode ? '#121212' : '#F8F9FB' }]}>
      ...
      <ScrollView contentContainerStyle={styles.container}>
        ...
        <View style={[styles.statusCard, { backgroundColor: isDarkMode ? '#1E1E1E' : '#FFFFFF' }]}>
          ...
          <Text style={[styles.title, { color: isDarkMode ? '#FFF' : '#333' }]}>E-KYC is Not Completed</Text>
          <Text style={styles.subtitle}>Please complete your verification to enable all AEPS features.</Text>
        </View>

        {/* Instruction Card */}
        <View style={[styles.instructionCard, { backgroundColor: isDarkMode ? '#1E1E1E' : '#FFFFFF' }]}>
           <Text style={[styles.cardTitle, { color: isDarkMode ? '#CCC' : '#666' }]}>Follow these steps:</Text>
           
           <View style={styles.stepRow}>
             <View style={styles.dot} /><Text style={[styles.stepText, { color: isDarkMode ? '#BBB' : '#444' }]}>Connect your Biometric Device (Mantra, Morpho, etc.) via OTG.</Text>
           </View>
           <View style={styles.stepRow}>
             <View style={styles.dot} /><Text style={[styles.stepText, { color: isDarkMode ? '#BBB' : '#444' }]}>Select your device model from the dropdown below.</Text>
           </View>
           <View style={styles.stepRow}>
             <View style={styles.dot} /><Text style={[styles.stepText, { color: isDarkMode ? '#BBB' : '#444' }]}>Click 'Scan Finger' and place your finger on the scanner.</Text>
           </View>
        </View>
